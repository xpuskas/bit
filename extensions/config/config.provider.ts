...
} from 'bit-bin/consumer/config/workspace-config';
import { Config } from './config';
import { ILegacyWorkspaceConfig, LegacyWorkspaceConfigProps } from 'bit-bin/consumer/config';
import { getConsumerInfo } from 'bit-bin/consumer';
