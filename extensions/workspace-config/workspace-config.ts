...
import LegacyWorkspaceConfig, { WorkspaceConfigProps } from 'bit-bin/consumer/config/workspace-config';
...
import { ILegacyWorkspaceConfig } from 'bit-bin/consumer/config';
